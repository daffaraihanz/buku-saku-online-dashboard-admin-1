        ...
        return(
            <Container fluid className="main-content-container">
                <Row noGutters className="page-header py-4">
                    ...
                    <Button onClick={this.toDataLala} className="mb-2 btn-back text-primary">
                        ...
                        <Col>
                            <Form>
                                <Row form>
                                    ...
                                    <FormInput
                                        name="kelas"
                                        placeholder="contoh: PASAL I Pendahuluan"
                                        // value={this.state.name}
                                        onChange={this.handleChange}
                                    />
                                    </Col>
                                </Row>
                                <Button  theme="accent" onClick={this.addKelas}>Tambah Pasal</Button>
                            </Form>
                        </Col>
                        </Row>
                    </ListGroupItem>
